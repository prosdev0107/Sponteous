...
export const columns = (
  ...
  onChangeDestination: ((id: string, value: boolean) => void),
    ...
    },
    {
      ...
      sortable: false,
      Cell: (props: RowRenderProps) => (
        <Switch onChange={() => { onChangeDeparture(props.row._original._id, !props.value) }} checked={props.value} />
      )
    },
    {
      Header: 'Destination',
      ...
      sortable: false,
      Cell: (props: RowRenderProps) => (
        <Switch onChange={() => { onChangeDestination(props.row._original._id, !props.value) }} checked={props.value} />
      )
    },
    {
      Header: 'Modify',
